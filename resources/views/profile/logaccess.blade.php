				...
				<ul class="list-group">
				  ...
				  <li class="list-group-item"><a href="#activity" class="dropdown-toggle" data-toggle="collapse">ACTIVITY LOG</a>
				  	<div class="list-group collapsed" id="activity">
					    ...
					    <a href="{{url('/') . '/profile/activity_log/logaccess'}}" class="list-group-item active">
			                        ...
			                        <div class="card-header">
			                            <div class="row" id="table_filters">
			                                ...
			                                <div class="col-md-12 mt-1">
			                                    <button type="button" class="btn btn-primary filter" data-id="filter_logaccess">
			                                        <i class="fa fa-filter"></i> Filter
			                                    </button>
			                                    <button type="button" class="btn btn-secondary" id="reset">
			                                        Reset Dates
			                                    </button>
			                                    <button id="exportLogAccess" class="btn btn-success float-right">Export to CSV</button>
			                                </div>
			                            </div>
			                        </div>
			                        <div class="card-body">
			                        	<table class="table table-bordered table-striped" id="logaccess_table" style="width: 100%;">
			                                <thead>
			                                    <tr>
			                                    	<th>Activity</th>
