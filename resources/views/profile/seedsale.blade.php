				...
				<div class="col-12">
					<nav aria-label="breadcrumb">
					  <ol class="breadcrumb">
					    ...
					    <li class="breadcrumb-item active" aria-current="page">Seed Sale</li>
					  </ol>
					</nav>
				</div>
			</div>
				...
				<ul class="list-group">
				  ...
				  <li class="list-group-item"><a href="#activity" class="dropdown-toggle" data-toggle="collapse">ACTIVITY LOG</a>
				  	<div class="list-group collapsed" id="activity">
					    ...
					    <a href="{{url('/') . '/profile/activity_log/seedsale'}}" class="list-group-item active">
			                        ...
			                        <div class="card-header">
			                            <div class="row" id="table_filters">
			                            	...
			                            	@permission(['view_regional_data'])
			                            		<input type="hidden" id="station" value="0">
			                            	...
			                            	<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
			                                    ...
			                                    <select class="form-control" id="status">
			                                    	<option value="none" selected>Transaction type</option>
			                                ...
			                                <div class="col-md-12 mt-1">
			                                    <button type="button" class="btn btn-primary filter" data-id="filter_seedsale">
			                                    ...
			                                    <button id="exportSeedSale" class="btn btn-success float-right">Export to CSV</button>
			                                </div>
			                            </div>
			                        </div>
			                        <div class="card-body">
