	...
	<div id="profile_content" class="col_no_padding">
		<div class="row">
			...
			<div class="d-none d-sm-block col-9 col-xl-9 col-md-8 col-sm-12">
				<div class="row">
					<div class="col-12">
						<h4 style="text-align: center;">GrowApp Data Submission Per Station</h4>
						<h4 style="text-align: center;">{{$croppingYear}} {{$semesterText}}</h4>
						<table class="table table-bordered mt-4">
							<thead>
								<tr>
									<th style="width: 40%;">PhilRice Station</th>
									<th style="width: 20%;">Area Submitted for Seed Certification</th>
									<th style="width: 20%;">Accredited Area</th>
