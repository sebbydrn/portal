				...
				<div class="col-12">
					<nav aria-label="breadcrumb">
					  <ol class="breadcrumb">
					    ...
					    <li class="breadcrumb-item active" aria-current="page">RSIS</li>
					  </ol>
					</nav>
				</div>
			</div>
	...
	<div id="about_us_content" class="col_no_padding">
		<div class="row">
			<div class="d-none d-sm-block col-3 col-xl-3 col-md-4 col-sm-12">
				<ul class="list-group">
				  <li class="list-group-item active"><a href="{{url('/') . '/about_us/rsis'}}">RSIS</a></li>
				  <li class="list-group-item"><a href="{{url('/') . '/about_us/objectives'}}">OBJECTIVES</a></li>
				  <li class="list-group-item"><a href="{{url('/') . '/about_us/implementers'}}">IMPLEMENTERS</a></li>
